...
//Share Extras changes start
      scrollIntoViewIframe(this.pages[this.page - 1]);
//Share Extras changes end
  ...
  set page(val) {
    ...
    if (this.loading && val == 1)
      return;
//Share Extras changes start
    scrollIntoViewIframe(pages[val - 1]);
//Share Extras changes start
  },
...
//ShareExtras Changes Start
        scrollIntoViewIframe(tempDiv,true);
//ShareExtras Changes End
...
//Share Extras Add start
function scrollIntoViewIframe(scrollObject, align){
   if (top.location!= self.location) {
      ...
      scrollObject.scrollIntoView(align);
      parent.window.scrollTo(currentleft,currenttop);
    } else {
   	 scrollObject.scrollIntoView(align);
    }
}
//Share Extras Add end
...
//Share Extras changes Start      	
        scrollIntoViewIframe(thumbnail);
//Share Extras changes end
    }
